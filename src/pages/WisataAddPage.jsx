      ...
      <form action="" required={true}>
        <div className="m-5">
          ...
          <div className="mt-5 mb-6">
            ...
            <div className="flex mt-1">
              <input
                style={{ padding: "10px" }}
                name="tujuan"
                className="w-full placeholder:text-sm placeholder:text-slate-400 block bg-[#e8edf1] border border-[#bfc3cb] rounded-sm py-2 pl-2 shadow-sm focus:outline-none focus:border-none focus:ring-[#f0ecec] focus:ring-1 md:text-md"
          ...
          <div className="mt-5 mb-6">
            ...
            <div className="flex mt-1">
              <input
                ...
                name="tujuan"
                className="w-full placeholder:text-sm placeholder:text-slate-400 block bg-[#e8edf1] border border-[#bfc3cb] rounded-sm py-2 pl-2 shadow-sm focus:outline-none focus:border-none focus:ring-[#f0ecec] focus:ring-1 md:text-md"
                placeholder="Sidodadi, Padang Cermin, Pesawaran Regency....."
                type="text"
              />
          ...
          <div className="mt-3">
            ...
            <textarea
              className="w-full h-[100px] bg-[#e8edf1]  p-2 rounded-sm border border border-[#bfc3cb] focus:outline-none focus:border-none focus:ring-[#f0ecec] focus:ring-1 md:text-md"
        ...
        <div className="m-5 mb-[20%]">
          ...
          <div className="wrapper">
            ...
            <label
              htmlFor="option-1"
              className="option bg-[#F2F2F2] shadow-md option-1"
            >
            ...
            <label
              htmlFor="option-2"
              className="ml-2 bg-[#F2F2F2] shadow-md option option-2"
            >
              <div className="dot"></div>
            ...
            <label
              htmlFor="option-3"
              className="ml-2 bg-[#F2F2F2] shadow-md option option-3"
            >
              <div className="dot"></div>
              <span>Belanja</span>
            </label>
          ...
          <div className="flex mt-3">
            <div className="wrapper">
              ...
              <label
                htmlFor="option-4"
                className="option bg-[#F2F2F2] shadow-md option-4"
              >
                <div className="dot"></div>
              ...
              <label
                htmlFor="option-5"
                className="ml-2 bg-[#F2F2F2] shadow-md option option-5"
              >
                <div className="dot"></div>
        ...
        <div className="flex p-4 z-50 bottom-0">
          <Button circled={true} fullWidth="true" submit={true} centered={true}>
            Tambah Wisata
          </Button>
        </div>
      </form>
