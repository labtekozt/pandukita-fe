    ...
    <div className="containerGuide pb-100">
      ...
      <div className="pb-[50%] z-20 p-5 bg-white relative rounded-2xl">
        ...
        <div className="flex mt-3">
          ...
          <div className="ml-1">
            <span className="text-sm">
              Dusun Sebalang, Tarahan, Kec. Katibung,Kab. Lampung Selatan,
              Lampung 35452
            </span>
          </div>
        </div>
        <div className="flex m-1 mb-3 mt-4">
          ...
          <h1 className="mt-1 ml-2 text-md text-[#00A388]">
            Buka di Google Map
          </h1>
        </div>
        <div className="pb-5">
        ...
        <div className="text-xl">
          ...
          <p className="mt-5">
            ...
            vel, eius, tempore esse, perferendis similique minus veniam dolorem
            aliquam praesentium ut totam nisi vitae? Consequuntur rerum saepe
        ...
        <div
          ...
          style={{ boxShadow: "0 2px 8px -1px #d2d3d3", transition: "0.5s" }}
        >
          <span>Galery</span>
