        ...
        <form action="" required={true}>
            <div className="m-5">
                ...
                <div className="mt-5 mb-6">
                    ...
                    <div className='flex mt-1'>
                        <input style={{padding : '10px', paddingLeft : '50px'}} name='tujuan' className="w-full placeholder:text-md placeholder:text-slate-900 block bg-[#e8edf1] border border-[#bfc3cb] rounded-md py-2 pl-1 shadow-sm focus:outline-none focus:border-none focus:ring-none focus:ring-none md:text-md" placeholder="Andrean Rahmatan" type="text"/>
                ...
                <div className="mt-5 mb-6">
                    ...
                    <div className='flex mt-1'>
                        <input style={{padding : '10px'}} name='tujuan' className="w-full placeholder:text-sm placeholder:text-slate-400 block bg-[#e8edf1] border border-[#bfc3cb] rounded-md py-2 pl-2 shadow-sm focus:outline-none focus:border-none focus:ring-none focus:ring-none md:text-md" placeholder="Lampung Selatan....." type="text"/>
                ...
                <div className='mt-3 mb-[30%]'>
                    ...
                    <textarea className='w-full h-[120px] bg-[#e8edf1] p-2 rounded-md border border-[#bfc3cb] shadow-sm focus:outline-none focus:border-none focus:ring-[#f0ecec] focus:ring-1 md:text-md' placeholder='Deskripsi tentang diri anda....' name="catatan"></textarea>
                </div>
            </div>
