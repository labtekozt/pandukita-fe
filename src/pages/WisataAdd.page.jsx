        ...
        <form action="" required={true}>
            <div className="m-5">
                ...
                <div className="mt-5 mb-6">
                    ...
                    <div className='flex mt-1'>
                        <input style={{padding : '10px'}} name='tujuan' className="w-full placeholder:text-sm placeholder:text-slate-400 block bg-[#e8edf1] border border-[#bfc3cb] rounded-md py-2 pl-2 shadow-sm focus:outline-none focus:border-none focus:ring-[#f0ecec] focus:ring-1 md:text-md" placeholder="Ekowisata Cukunyinyi Mangrove..." type="text"/>
                    </div>
                </div>
                <div className="mt-5 mb-6">
                    <h1 className='text-md mb-1'>Lokasi Wisata?</h1>
                    <div className='flex mt-1'>
                        <input style={{padding : '10px'}} name='tujuan' className="w-full placeholder:text-sm placeholder:text-slate-400 block bg-[#e8edf1] border border-[#bfc3cb] rounded-md py-2 pl-2 shadow-sm focus:outline-none focus:border-none focus:ring-[#f0ecec] focus:ring-1 md:text-md" placeholder="Sidodadi, Padang Cermin, Pesawaran Regency....." type="text"/>
            ...
            <div className='map mb-5'>
                ...
                <div className='mt-3'>
                    ...
                    <textarea className='w-full h-[100px] bg-[#e8edf1]  p-2 rounded-md border border border-[#bfc3cb] focus:outline-none focus:border-none focus:ring-[#f0ecec] focus:ring-1 md:text-md' placeholder='Deskripsi Tempat Wisata....' name="catatan"></textarea>
                </div>
            </div>
            ...
            <div className='flex p-4 z-50 bottom-0'>
                <Button circled={true} fullWidth="true" submit={true} centered={true}>Tambah</Button>
            </div>
        </form>
        </div>
    )
