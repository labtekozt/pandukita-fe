        ...
        <form action="">
            ...
            <a href="/plannerai">
                <div className='flex p-4 mt-[-20px] z-50 bottom-0'>
                    <button style={{color: 'rgba(0, 102, 255, 1)', borderRadius : '4px', backgroundColor : 'rgba(152, 193, 255, 0.46)'}} className='text-md p-[11px] w-full'>Buat Rencana Otomatis</button>
                    <IconRobot color='rgba(0, 102, 255, 1)' className='planner-icon mr-2 absolute ml-[350px] mt-2'/>
                </div>
            </a>
        </div>
    )
