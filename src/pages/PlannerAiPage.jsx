        ...
        <div className="container">
            ...
            <div className='pb-[5%]'>
                ...
                <div className='flex m-6 mt-[180px]'>
                    <Button size="small" type="primary" href='/lihatpetaall'><span className='pl-5'>Lihat di Peta </span></Button>
                ...
                <div className='m-6'>
                    <Tile
                        ...
                        <div className='pb-10'>
                            ...
                            <div className='flex items-center justify-center p-1'>
                                <Button size="small" type="primarySubtle" href='/planneradd'><span className='pl-6'>Tambah Tujuan</span></Button>
                                <span className='mr-[29%] m-2 absolute'><IconMapPinSearch width={19} color='#00A388' /></span>
                            </div>
                        </div>
                    </Tile>
                </div>
            ...
            <div className='mt-[-15px] p-4 z-50 bottom-0'>
                <Button type="primarySubtle" fullWidth="true" submit={true} centered={true} href='sewapemandu'>Sewa Pemandu Wisata</Button>
            </div>
        </div>
    )
}
