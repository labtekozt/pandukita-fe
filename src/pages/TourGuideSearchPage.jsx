...
import { Stack, TextLink, Button, Text } from "@kiwicom/orbit-components/lib/";
      ...
      <div className="m-5 mt-[40px] pb-[100%]">
        <div className="pb-10">
          ...
          <div className="flex items-center justify-center p-1">
            <Text align="center">
              Maaf, halaman tidak ditemukan. <br /> Yok bantu kami menambah
              informasi wisata
            </Text>
          </div>
          <div className="flex items-center justify-center p-1">
